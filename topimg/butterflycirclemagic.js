 ...
 * - /gh/weilining/jsdelivr@master/jquery/circlemagic/circlemagic.min.js
 * - /gh/weilining/jsdelivr@master/jquery/circlemagic/butterflycirclemagic.js
 *
...
function(t) {
	t.fn.circleMagic = function(a) {
		...
		function f() {
			if (i) for (var t in r.clearRect(0, 0, e, o), d) d[t].draw();
		...
		function m() {
			...
			function a() {
				...
				t.alpha = .1 + Math.random() * c.clearOffset,
				t.scale = .1 + .3 * Math.random(),
				t.speed = Math.random(),
				"random" === c.color ? t.color = "rgba(" + Math.floor(255 * Math.random()) + ", " + Math.floor(255 * Math.random()) + ", " + Math.floor(255 * Math.random()) + ", " + Math.random().toPrecision(2) + ")": t.color = c.color
			}
			t.pos = {},
			a(),
			this.draw = function() {
...
//# sourceMappingURL=/sm/99441eb9fab7b5fff7d180aa9760c1861eb19304e926398c2d668a34c2e6167e.map
