...
(function($){
	$.fn.snow = function(options){
		...
		var interval= setInterval(function(){
			...
			endPositionTop = documentHeight - 200,	// 此处可以定义雪花下落消失的位置
			endPositionLeft = (((startPositionLeft - 500) > 0) ? (startPositionLeft - 300 + 500 * Math.random()) : (startPositionLeft + 200)),	// 获取雪片消失时距离浏览器左边的距离
