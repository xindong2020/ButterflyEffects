...
function() {
	...
	var h = document.getElementById(snow),
	w = h.getContext(2d),
	m = t,
	v = -100,
	c = -100,
	...
	var f = function p() {
		if (s) {
			...
			t = 0; t  m; t++) {
				...
				w.fillStyle = rgba( + n + ,  + o.opacity + ),
				o.y += o.velY,
				o.x += o.velX,
				(o.y = h.height  o.y = 0) && g(o),
				(o.x = h.width  o.x = 0) && g(o),
				w.beginPath(),
				w.arc(o.x, o.y, o.size, 0, 2  Math.PI),
				w.fill()
			}
			l(p)
		}
	...
	g = function(e) {
		e.x = Math.floor(Math.random()  h.width),
		e.y = 0,
	...
	M = function() {
		for (var e = 0; e  m; e++) {
			var t = Math.floor(Math.random()  h.width),
			i = Math.floor(Math.random()  h.height),
			n = 3  Math.random() + o,
			s = 1  Math.random() + a,
			l = .5  Math.random() + d;
			u.push({
	...
	function() {
		var e;
		if (null !== localStorage.getItem(kr-disable-snow)  !1 === (null === (e = window.kr)  void 0 === e  void 0  e.notMobile)) return s = !1,
		void h.classList.add(disabled);
		M()
	} ()
} ();
# sourceMappingURL=..mapssnow.min.js.map
